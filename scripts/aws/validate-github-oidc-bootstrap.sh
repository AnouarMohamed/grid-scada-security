...
readonly TEMPLATE="${REPOSITORY_ROOT}/infra/cloudformation/bootstrap/github-oidc-plan-role.yaml"
export AWS_PAGER=""
...
values = {
    ...
    "StateBucketName": f"gridguard-tfstate-{account_id}-{region}",
...
policy = template["Resources"]["GitHubPlanPolicy"]["Properties"]["PolicyDocument"]
...
printf 'PASS  Named-IAM capability and seven expected parameters are declared\n'
